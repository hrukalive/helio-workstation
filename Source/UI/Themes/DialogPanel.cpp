...
<JUCER_COMPONENT documentType="Component" className="DialogPanel" template="../../Template"
  ...
  <BACKGROUND backgroundColour="0">
    <ROUNDRECT pos="0 0 0M 0M" cornerSize="7.0" fill=" radial: 0 -200R, 0R 0, 0=ff3b5297, 1=ff292c57"
               hasStroke="0"/>
    <ROUNDRECT pos="0 0 0M 0M" cornerSize="7.0" fill="linear: 52% 120%, 48% -20%, 0=3a193477, 1=0"
               hasStroke="0"/>
    <ROUNDRECT pos="0 0 0M 0M" cornerSize="7.0" fill="linear: 52% 130%, 48% -30%, 0=3a193477, 1=0"
               hasStroke="0"/>
    <ROUNDRECT pos="0 0 0M 0M" cornerSize="7.0" fill="linear: 52% 130%, 48% -30%, 0=3a193477, 1=0"
